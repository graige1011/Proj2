...
class UserTest {
    ...
    public void TestCCValidateRegistration() {
        ...
        boolean actualResult1 = User.validateRegistration(username1, password1);
        ...
        boolean actualResult2 = User.validateRegistration(username2, password2);
    ...
    public void TestMCCValidateRegistration() {
        ...
        boolean actualResult3 = User.validateRegistration(username3, password3);
        ...
        boolean actualResult4 = User.validateRegistration(username4, password4);
